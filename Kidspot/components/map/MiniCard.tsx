...
export default function MiniCard({ place, onDismiss, onNavigate }: Props) {
  ...
  return (
    <Animated.View
      ...
      // Quando visível: box-none não captura toque na View mas filhos (Pressable) capturam.
      // Quando escondido (place=null): none → nenhum toque interceptado, marcadores recebem o evento.
      pointerEvents={place ? "box-none" : "none"}
      // Impede que o toque no card propague para o MapView (que fecharia o card)
